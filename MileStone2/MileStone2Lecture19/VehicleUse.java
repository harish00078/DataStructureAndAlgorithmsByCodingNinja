...
public class VehicleUse {
    ...
    public static void main(String[] args) {
        ...
        /// here we working on the lecturre 19 topics;

        // here we user abstract keyword:
        // Vehicle v = new Vehicle() /// here we  have an error in the vehicle use :
        // because when we convert any class into the absract class it means.that class is complete.
        // acc to compling system we did not use the any incomplete parent class to any were:

        // // here we have one exception that we did not use the abstract to create a new class:
        // // but we can create parent class refrence:like this:
        // Vehicle v; // here we create  a refernce of the parent class:

        // // know we can use the car class:
        // Car c = new Car();
        // v = new Car();
        // v.print();  /// here we check the abstract output for the car class:
        // // v = new Bicycle(); // here we check the abstract output for the bicycle class:
