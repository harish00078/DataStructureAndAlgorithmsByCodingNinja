...
public class RootToNodePathInBinaryTree {
    ...
    public static ArrayList<Integer> RootToNodePath(CreateBinaryTreeNode<Integer> root, int x){
        if(root == null){
            return null;
        }
  ...
  public static CreateBinaryTreeNode<Integer> takeTreeInputBetter(boolean isRoot, int parentData, boolean isLeft){
    ...
    public static void main(String[] args) {
        ...
        // here we use the function that we have created: for finding the path  of given number in the TRee:
        ArrayList<Integer> path = RootToNodePath(root, 5);
        if(path == null){
