...
public class ProblemRatInMazePrintPath {
    ...
    public static boolean ratInAMaze(int maze[][]){
        ...
        return SinglePath(maze, 0, 0, path);// and here we are returning the values of this function acc to our:
    ...
    public static Boolean SinglePath(int maze[][], int i, int j, int path[][] ){
