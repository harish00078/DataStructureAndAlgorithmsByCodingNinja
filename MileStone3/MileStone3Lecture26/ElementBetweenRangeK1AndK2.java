...
public class ElementBetweenRangeK1AndK2 {

    public static void ElementInRangeK1AndK2(CreateBinaryTreeNode<Integer> root, int k1,int k2){
        ...
        if(root.data  < k1){
            ...
            ElementInRangeK1AndK2(root.right, k1,k2);
        }else if(root.data > k2){
            ElementInRangeK1AndK2(root.left, k1, k2);
  ...
  public static CreateBinaryTreeNode<Integer> takeTreeInputBetter(boolean isRoot, int parentData, boolean isLeft){
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(ElementInRangeK1AndK2(root, 0, 8));
